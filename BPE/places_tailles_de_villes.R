...
data_communes_des_au <- read.csv(file = "BDD_services_publics/data_sorties/services_publics_communes_des_aires_urbaines_long.csv", 
...
data_communes_des_au <- data_communes_des_au %>%
  ...
  mutate(AU2010 = as.character(AU2010)) %>%
  left_join(., y = sf_services_publics_aires_urbaines %>% select(AU2010, tailles_2016) %>% unique(), by = "AU2010")
...
ggsave(filename = "evo_emplois_avec_et_sans_conseiller_carto_bretagne_donnees_pole_emploi.png", plot = last_plot(), 
       path = "BPE/sorties/tailles_villes_places_services_publics/figures/1.4.services_emplois_sans_conseiller", device = "png",
       width = 25, height = 25, units = "cm")
